  ...
  if(isset($_GET['filter'])){
		...
		if($rating != "" && $loc != ""  && $data != ""){
			$sqlget = "select * from addtable 
					where tip='aparitia_cersetoriei' and localitate = '$loc' order by likes $rating , data_adaugare $data ";
		}
		else if($rating != "" && $loc != "" &&$data == ""){
			$sqlget = "select * from addtable 
					where tip='aparitia_cersetoriei' and localitate = '$loc' order by likes $rating ";
		}
		else if($rating != "" && $loc == "" &&$data != ""){
			$sqlget = "select * from addtable 
					where tip='aparitia_cersetoriei' order by likes $rating , data_adaugare $data ";
		}
		else if($rating == "" && $loc != "" &&$data != ""){
			$sqlget ="select * from addtable 
					where tip='aparitia_cersetoriei' and localitate = '$loc' order by data_adaugare $data ";
		}
		else if($rating != "" && $loc == "" &&$data == ""){
			$sqlget = "select * from addtable 
					where tip='aparitia_cersetoriei' order by likes $rating ";
		}
		else if($rating == "" && $loc != "" &&$data == ""){
			$sqlget = "select * from addtable 
					where tip='aparitia_cersetoriei' and localitate = '$loc' ";
		}
		else if($rating == "" && $loc == "" &&$data != ""){
			$sqlget = "select * from addtable 
					where tip='aparitia_cersetoriei' order by data_adaugare $data";
		}
